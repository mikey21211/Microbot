...
public class Rs2AntibanSettings {
    ...
    public static boolean simulateFatigue = true;
    public static boolean simulateAttentionSpan = true;
    public static boolean behavioralVariability = true;
    public static boolean nonLinearIntervals = true;
    public static boolean profileSwitching = true;
    ...
    public static double moveMouseRandomlyChance = Rs2Random.gaussRand(0.73, 0.095); // Chance of moving the mouse randomly by default
    public static double moveMouseOffScreenChance = Rs2Random.gaussRand(0.78, 0.05); // Chance of moving the mouse off screen by default
    ...
    public static void reset() {
        ...
        simulateAttentionSpan = true;
        behavioralVariability = true;
        nonLinearIntervals = true;
        ...
        microBreakDurationLow = 1;
        microBreakDurationHigh = 1;
        actionCooldownChance = 0.1;
        microBreakChance = 0.1;
        moveMouseRandomlyChance = Rs2Random.gaussRand(0.73, 0.095);
        moveMouseOffScreenChance = Rs2Random.gaussRand(0.78, 0.05);
    }
}