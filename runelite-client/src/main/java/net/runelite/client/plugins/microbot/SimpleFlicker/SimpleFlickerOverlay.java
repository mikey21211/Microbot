...
public class SimpleFlickerOverlay extends OverlayPanel {
    public final ButtonComponent myButton;
    @Inject
    SimpleFlickerOverlay(SimpleFlickerPlugin plugin)
    {
        super(plugin);
        setPosition(OverlayPosition.TOP_LEFT);
        setNaughty();
        myButton = new ButtonComponent("SimpleFlicker");
        ...
        myButton.setOnClick(() -> Microbot.openPopUp("Microbot", String.format("S-1D:<br><br><col=ffffff>%s Popup</col>", "SimpleFlicker")));
    }
    @Override
    public Dimension render(Graphics2D graphics) {
        try {
            ...
            panelComponent.getChildren().add(TitleComponent.builder()
                    .text("Micro SimpleFlicker ML V1.0.0")
                    .color(Color.GREEN)
                    .build());
